      ...
      {!abierto && (
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 6px 35px rgba(0,0,0,0.4)';
          }}
          onMouseLeave={(e) => {
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
              ...
              <div>
                <div style={{ fontWeight: '500' }}>Asistente IA</div>
                <div style={{ fontSize: '0.7rem', opacity: 0.7 }}>Prototipica Estudio</div>
              </div>
            </div>
          ...
          <div style={{
            ...
            {conversacion.map((msg, i) => (
              <div
                ...
                style={{
                  ...
                  background: msg.tipo === 'usuario' ? '#1a1a1a' : 'white',
            ...
            {cargando && (
              <div style={{
                ...
                <span style={{ color: '#888', fontSize: '0.9rem' }}>Escribiendo...</span>
