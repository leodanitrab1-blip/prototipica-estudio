...
export default function Cotizar() {
  const [form, setForm] = useState({ nombre: '', email: '', telefono: '', descripcion: '', presupuesto: '' });
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '1rem' }}>
      ...
      <p style={{ color: '#666', marginBottom: '2rem' }}>Cuéntanos tu idea y te enviaremos un presupuesto personalizado.</p>
